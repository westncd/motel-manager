...
int main(){
	string tb;
	string tk, mk;
	bool run1 = true, run2 = true, run3 = true, run4 = true, run7 = true;
	int choice1, choice2, choice5, choice6, choice7, index = 0, index1 = 0, index2 = 0;
			...
			do{
				...
				switch(choice2){
					...
					case 1:{
						...
						do{
							cout <<"--------------"<<endl;
						 	cout <<"Ban co muon nhap them phong tro khong?  1.Co / 2.Khong"<<endl;
							do{	
